...
class provide_TagSettings
{
    ...
    public function __construct()
    {
        $this->icon = '';
        $this->id = 'tag';
        $this->title = esc_html__('Tag', 'provide');
        $this->desc = esc_html__('Theme Tag Template Settings', 'provide');
    }
    ...
    public function provide_init()
    {
        return array(
            array(
                ...
                'desc' => esc_html__('Show or hide tag page header section', 'provide'),
                'default' => false,
