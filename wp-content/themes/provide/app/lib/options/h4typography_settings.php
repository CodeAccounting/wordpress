...
class provide_h4typographySettings
{
    public $icon;
    public $id;
    public $title;
    ...
    public function __construct()
    {
        ...
        $this->title = esc_html__('H4 Styling', 'provide');
        $this->desc = esc_html__('provide Theme H4 Typography Settings', 'provide');
    }
    ...
    public function provide_init()
    {
        return array(
            array(
                'id' => 'optH4Typo',
                'type' => 'switch',
                'title' => esc_html__('H4 Typography', 'provide'),
