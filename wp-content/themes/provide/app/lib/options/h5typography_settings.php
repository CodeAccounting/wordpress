...
class provide_h5typographySettings
{
    public $icon;
    public $id;
    public $title;
    ...
    public function __construct()
    {
        ...
        $this->title = esc_html__('H5 Styling', 'provide');
        $this->desc = esc_html__('provide Theme H5 Typography Settings', 'provide');
    }
    ...
    public function provide_init()
    {
        return array(
            array(
                'id' => 'optH5Typo',
                'type' => 'switch',
                'title' => esc_html__('H5 Typography', 'provide'),
