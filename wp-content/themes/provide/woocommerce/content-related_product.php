...
$size = array('m' => '270x348', 'i' => '270x348', 'w' => '270x348');
global $product;
$h = new provide_Helper();
?>
<div class="col-md-3 col-sm-6 col-xs-6 col-mr-12 wow fadeIn" data-wow-delay="0.1s">
    <div class="product-item">
        <div class="product-item-thumb">
            <?php echo $imagify->provide_thumb($size, true, array(true, true, true)); ?>
            <ul>
