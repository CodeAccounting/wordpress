...
class AnpsContact extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'AnpsContact', __('AnpsThemes - Contact', 'accounting'), array('description' => __('Enter contact.', 'accounting'),)
        );
    ...
    function form($instance) {
        ...
        ?>
        <p> 
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title', 'accounting'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('text')); ?>"><?php esc_html_e('Text', 'accounting'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('button_text')); ?>"><?php esc_html_e('Button text', 'accounting'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('url')); ?>"><?php esc_html_e('Url', 'accounting'); ?></label>
        ...
        <!-- colors -->
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title_color')); ?>"><?php esc_html_e('Title color', 'accounting'); ?></label><br />
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('text_color')); ?>"><?php esc_html_e('Text color', 'accounting'); ?></label><br />
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('bg_color')); ?>"><?php esc_html_e('Background color', 'accounting'); ?></label><br />
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('button_text_color')); ?>"><?php esc_html_e('Button text color', 'accounting'); ?></label><br />
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('button_bg_color')); ?>"><?php esc_html_e('Button background color', 'accounting'); ?></label><br />
    ...
    function widget($args, $instance) {
        ...
        <div class="widget-wrap" <?php echo esc_html($bg_color_att);?>>
            <div class="widget-content col-md-12">
                ...
                <?php endif;?> href="<?php echo esc_url($url);?>" style=""><?php echo esc_html($button_text);?></a>
             </div>
        </div>
        <?php
        echo $after_widget;
