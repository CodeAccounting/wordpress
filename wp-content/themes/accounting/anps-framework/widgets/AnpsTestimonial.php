...
class AnpsTestimonial extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'AnpsTestimonial', 'AnpsThemes - Testimonial', array('description' => __('Enter testimonial', 'accounting'),)
        );
    }
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('image')); ?>"><?php esc_html_e('Image', 'accounting'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('name')); ?>"><?php esc_html_e('Name', 'accounting'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('job_title')); ?>"><?php esc_html_e('Job title', 'accounting'); ?></label>
