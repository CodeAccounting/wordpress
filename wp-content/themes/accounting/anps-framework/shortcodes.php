...
function anps_team_func($atts, $content) {
    ...
    while($team_posts->have_posts()) : 
        ...
        $google_plus = get_field('google_plus'); $facebook = get_field('facebook'); $twitter = get_field('twitter'); $linkedin = get_field('linkedin');
        $team_data .= "<div class='team_social'><a href='".$google_plus."' target='_blank'><i class='fa fa-google-plus-square' aria-hidden='true'></i></a><a href='".$facebook."' target='_blank'><i class='fa fa-facebook-square' aria-hidden='true'></i></a><a href='".$twitter."' target='_blank'><i class='fa fa-twitter-square' aria-hidden='true'></i></a><a href='".$linkedin."' target='_blank'><i class='fa fa-linkedin-square' aria-hidden='true'></i></a></div>";
        $team_data .= "</div></div>";
    endwhile;
    wp_reset_postdata();
    $text_only = false;
