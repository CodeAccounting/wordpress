...
<form action="themes.php?page=theme_options&sub_page=theme_style_custom_font&save_font" method="post" enctype="multipart/form-data">
    ...
    <div class="content-inner">
        <h3 style="margin-bottom: 30px"><?php _e("Upload custom fonts", 'accounting'); ?></h3>
        <p><?php esc_html_e('To maximize your customization you can upload your own typography. Simply upload your font from your computer.', 'accounting'); ?></p>
