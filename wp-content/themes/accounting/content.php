...
if(is_sticky(get_the_ID())) {
    ...
    $id = get_the_ID();
    //$post_class = $sticky_class .' '. $id;
    //$post_data = '<article id="site-content" class="post style-2{$post_class}" >';
    $post_data = "<article id='site-content' class='post style-2$sticky_class post-".$id."'>";
    $post_data .= "<header>";
