            ...
            <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-12 buttons folionav">
                        <?php previous_post_link( '%link', '<button class="btn btn-lg style-5"><i class="fa fa-angle-left"></i> &nbsp; ' . __('prev', 'accounting')."</button>" ); ?>
                        <?php next_post_link( '%link', '<button class="btn btn-lg style-5">'.__("next", 'accounting') . ' &nbsp; <i class="fa fa-angle-right"></i></button>' ); ?>
                    </div>
                </div>
            </div>
        <?php else : ?>
