    ...
    class ReduxFramework_language
    {
        ...
        public function render()
        {
            ...
            <div class="language-switcher-uploader" data-id="opt-<?php echo esc_attr($this->field['id']) ?>">
                ...
                <a id="delete-mo-file" href="javascript:void(0)"><?php esc_htmL_e('Delete', 'provide') ?></a>
                <div class="form-wrap">
                    <h3><?php esc_html_e('Upload Language File', 'provide') ?></h3>
                    <form enctype="multipart/form-data" id="language_uploader">
                        <div class="language-file">
                            <label for="language_file"><i class="el el-upload"></i><?php esc_html_e('Browse', 'provide') ?></label>
                            <input id="language_file" name="language_file" type="file"/>
                        </div>
                        <a id="upload_file" name="upload_file"><i class="el el-refresh"></i><?php esc_html_e('Start Upload', 'provide') ?></a>
                    </form>
                    <div id="progress-wrp">
        ...
        public function enqueue()
        {
            ...
            $translation_array = array(
                'switcher' => esc_html__('Select Language', 'provide'),
                'api_error' => esc_html__('Your browser does not support new File API! Please upgrade', 'provide'),
                'no_file' => esc_html__('Please Select a .mo file', 'provide'),
                'unsupported' => esc_html__('Unsupported file type', 'provide'),
                'bigFile' => esc_html__('Too big file', 'provide'),
                'selectFile' => esc_html__('Please Select Language File', 'provide'),
                'del' => esc_html__('Delete', 'provide'),
            );
