	...
	class ReduxFramework_extra_datetime extends ReduxFramework {
		...
		public function enqueue() {
			...
			wp_localize_script( 'redux-extra-datetime-js', 'redux_extra_datetime_js_lang', array(
				'date_format' => $this->dateformat_to_js( get_option( 'date_format' ) ),
				'time_format' => $this->dateformat_to_js( get_option( 'time_format' ) )
			) );
			wp_enqueue_script(
		...
		public function dateformat_to_js( $php_format ) {
